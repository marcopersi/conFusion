describe('Controller: MenuController', function () {
  ...
  //workaround for Karma/ui-router conflict, was not part of lessons
  ...
  // the string could contain anything is just for the programmer to understand what the test does
